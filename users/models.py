...
class SiteConfiguration(models.Model):
    light_mode_svg = models.FileField("Light Mode SVG Logo", upload_to='sitelogo/', blank=True, null=True)
    light_mode_img = models.ImageField("Light Mode Image Logo", upload_to='sitelogo/', blank=True, null=True)
    dark_mode_svg = models.FileField("Dark Mode SVG Logo", upload_to='sitelogo/', blank=True, null=True)
    dark_mode_img = models.ImageField("Dark Mode Image Logo", upload_to='sitelogo/', blank=True, null=True)
